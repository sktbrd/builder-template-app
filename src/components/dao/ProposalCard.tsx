  ...
  return (
    ...
    >
        ...
        <div className="relative h-[140px] w-full shrink-0 overflow-hidden">
          {p.thumbnail ? (
            ...
            <div
              ...
              style={{ background: proposalGradient(p.id) }}
            />
          )}
      ...
      >
        ...
        {/* Title — 2-line clamp */}
        <p
          className="line-clamp-2 text-[18px] font-semibold leading-[1.3] text-fg m-0"
